 ...
 * Trains with the lyrics to Albuquerque, by Weird Al Yankovic
 * Lyrics from https://www.azlyrics.com/lyrics/weirdalyankovic/albuquerque.html
 * @author Chris
 * I just needed some more diversity with words. Didn't realize until afterwards
 * that I probably could have connected this to a dictionary site. This is
 * more entertaining, though has the side effect of making "Albuquerque" one of the
 * top pick when starting a word with the letter A.
 */
public class AlbuquerqueTrainingFile implements Runnable {

	AutocompleteProvider autoc;
	
	public AlbuquerqueTrainingFile(AutocompleteProvider a) {
		autoc = a;
	}
